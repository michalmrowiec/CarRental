...
const BookingWidget = () => {
    ...
    const handleReservation = () => {
        ...
        setSelectedDate({ from: pickupDate, fromTime: pickupTime, to: returnDate, toTime: returnTime });
    ...
    return (
        <Container className="booking-widget ">
            ...
            <Form className='p-1'>
                ...
                <Button color="primary" onClick={handleReservation} disabled={!pickupDate || !pickupTime || !returnDate || !returnTime}>Go</Button>
            </Form>
        </Container>
    );
};
