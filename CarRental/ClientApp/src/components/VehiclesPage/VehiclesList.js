...
const VehiclesList = () => {
    ...
    const fetchVehicles = async (page, pageSize) => {
        const response = await fetch(
            "https://localhost:44403/api/v1/Vehicle/get-filtered",
            {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    page: page,
                    pageSize: pageSize,
                    from: selectedDate.from, //filterFrom === "" ? null : filterFrom,
                    to: selectedDate.to //filterTo === "" ? null : filterTo,
                }),
            }
        );
        ...
        <div className="container">
            <Row className="mb-3">
                ...
                <Col md={4} className="d-flex align-items-end">
                    <Button color="primary" className="me-2" onClick={applyFilters}>
                        Filter
                    </Button>
